...
class BytecodeParser {
  ...
  static Opcode _parseOpcode(String name) {
    return switch (name.toLowerCase()) {
      ...
      'pop' => Opcode.pop,
      'dup' => Opcode.dup,
      'load_reg' || 'loadreg' => Opcode.loadReg,
      'store_reg' || 'storereg' => Opcode.storeReg,
      'add' => Opcode.add,
      'sub' => Opcode.sub,
      'mul' => Opcode.mul,
      'div' => Opcode.div,
      ...
      'make_object_here' || 'makeobjecthere' => Opcode.makeObjectHere,
      'make_map' || 'makemap' => Opcode.makeMap,
      'op_in' || 'opin' => Opcode.opIn,
      'op_match' || 'opmatch' => Opcode.opMatch,
      'op_not_match' || 'opnotmatch' => Opcode.opNotMatch,
